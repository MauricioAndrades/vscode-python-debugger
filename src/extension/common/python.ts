...
/**
 * Executes a specified command from the Python extension after ensuring the extension is activated.
 *
 * @param command - The identifier of the command to execute.
 * @param rest - Additional arguments to pass to the command.
 * @returns A promise that resolves with the result of the executed command.
 */
...
/**
 * Resolves detailed information about a given Python environment.
 *
 * @param env - The environment to resolve. Can be an `Environment`, `EnvironmentPath`, or a string identifier.
 * @returns A promise that resolves to the detailed environment information.
 */
